...
impath = 'C:\\Users\\lenai\\OneDrive\\Desktop\\Cesar\\'
...
def event(cycle, check, event_number, x):
    if event_number in idle_num:
        ...
        window.after(300, update, cycle, check, event_number, x)  # no. 6,7 = walk towards left
    elif event_number in walk_right:
        check = 5
        print('walking towards right')
        window.after(300, update, cycle, check, event_number, x)  # no 8,9 = walk towards right
...
def update(cycle, check, event_number, x):
    ...
    window.geometry('64x64+' + str(x) + '+1016')
